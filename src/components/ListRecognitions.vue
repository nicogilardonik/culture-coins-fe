<template>
  ...
  import MyRecognitionsCard from '@/components/MyProfile/layout/MyRecognitionsCard.vue';
  
  export default {
    name: 'ListRecognitions',
...
props: {
    ...
    mounted() {
      this.getMyRecognitions(this.email)
      this.setTitle()
    },
